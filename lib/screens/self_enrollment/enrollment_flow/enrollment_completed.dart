...
class EnrollmentCompleted extends StatefulWidget {
  const EnrollmentCompleted({Key? key}) : super(key: key);

  @override
  State<EnrollmentCompleted> createState() => _EnrollmentCompletedState();
}

class _EnrollmentCompletedState extends State<EnrollmentCompleted> {
