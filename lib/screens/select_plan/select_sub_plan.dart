...
class SelectSubPlan extends StatefulWidget {
  final OfflineEnrolleeData offlineEnrolleeData;
  final bool isfromOffline;
  const SelectSubPlan({Key? key, required this.offlineEnrolleeData, required this.isfromOffline}) : super(key: key);

  @override
  State<SelectSubPlan> createState() => _SelectSubPlanState();
}

class _SelectSubPlanState extends State<SelectSubPlan> {
  String? selectedPlan;
